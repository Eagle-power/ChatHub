    ...
    <header className="bg-white border-b border-gray-200 shadow-sm">
      <div className="px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            <div className="bg-gradient-to-r from-violet-500  to-indigo-500 p-2 rounded-xl shadow-lg shadow-indigo-500/40">
          ...
          {/* User Profile.. */}
          <div className="flex items-center space-x-3">
            <div className="flex items-center space-x-3 bg-gray-50 px-3 py-1.5 rounded-full border-gray-100">
              <div className="relative">
                <GetUserIcon name={currentUser?.username} size={7} />
                <div
                  className="absolute -bottom-0.5 -right-0.5 w-2.5  h-2.5 bg-emerald-500 
      ...
      <div className="px-4 py-2  bg-white border-2 border-gray-100 flex items-center space-x-2 overflow-x-auto">
        <div className="flex -space-x-2 mr-3">
          ...
          {
            users.length > 5 && <div className="w-8 h-8 rounded-full ring-2 ring-white bg-gray-100
                                                flex items-center">
